...
|---|-------|-------------|--------------|
| 1 | [Limpieza y transformación](./1_Limpieza_y_Transformacion_Python) | Consolidación de las 5 fuentes en un dataset limpio | pandas |
| 2 | [Análisis exploratorio (EDA)](./2_Analisis_Exploratorio_EDA) | Distribución, tendencias y outliers | Matplotlib, Seaborn |
| 3 | [Segmentación K-Means](./3_Clustering_K-Means) | Agrupamiento de productos por desempeño | scikit-learn |
| 4 | [Análisis con SQL](./4_Analisis_SQL) | Data warehouse y consultas de negocio | SQLite |
| 5 | [Dashboard](./5_Dashboard_PowerBI) | Tablero interactivo de resultados | Power BI |
| 6 | [Predicción de ventas](./6_Prediccion_Machine_Learning) | Pronóstico con series de tiempo | statsmodels (ARIMA) |

📸 La carpeta [`capturas/`](./capturas) reúne las visualizaciones y outputs clave del proyecto.
